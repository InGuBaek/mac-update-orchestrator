# mac-update-orchestrator quickstart (fr-CA)

Audience: Canada / Canadian French
...
Cet outil ne force pas le redémarrage et ne remplace pas automatiquement les applications autonomes.
